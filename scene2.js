...
function scene2Draw() {
  ...
  textSize(16);
  fill(118, 97, 83);
  text("Water should be...", 200, 150);
  drawButton(100, 200, 100, 40, "Still", isMouseOver(100, 200, 100, 40));
  drawButton(300, 200, 100, 40, "Wild", isMouseOver(300, 200, 100, 40));
}
...
function scene2MousePressed() {
  if (isMouseOver(100, 200, 100, 40)) {
    console.log("Still button clicked!");
    goToScene(4);
  }
  if (isMouseOver(300, 200, 100, 40)) {
    console.log("Wild button clicked!");
    goToScene(5);
  }
}
